					...
					%>
						<table class="table table-bordered table-dark table-hover">
						  ...
						  <tbody>
						  	...
						  	<% 
						  		out.print("<form action='inserir?action=inserir2' method='POST'>");
						   		out.print("<tr>");
								    ...
								    out.print("<td> <input required minlength='2' maxlength='50' type='text' name='name_author' style='background-color: #454d55; border-color: #454d55; color: white;'> </input> </td>");
								    out.print("<td> <input required type='date' name='date' style='background-color: #454d55; border-color: #454d55; color: white;'> </input> </td>");
